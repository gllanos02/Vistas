<?php
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        curl_close($curl);
        $cat_re = json_decode($response, true);
...
<html lang="es">
    <head>
        ...
        <title>Registrar Categoría | CRAI-Tarapoto</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card card-primary card-outline">
                                    <h3 class="text-center mt-4">Nueva Categoría</h3>
                                    <div class="container">
                                        <form method="post" class="col-xl-8 offset-2">
                                            <div class="form-group">
                                                <label for="cog_categoria">Codigo de Categoria:</label>
                                                <input type="number" name="cog_categoria" class="form-control" id="cog_categoria" placeholder="Ingrese el Codigo" />
                                            </div>

                                            <div class="form-group">
                                                <label for="descripcion">Descripción:</label>
                                                <input type="text" name="descripcion" class="form-control" id="descripcion" placeholder="Ingrese la Descripción" />
                                            </div>
