...
<html lang="es">
    <head>
        ...
        <title>Categorías de Libros | CRAI-Tarapoto</title>
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">Categorías de Libros</h1>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active">Categorías de Libros</li>
                                </ol>
                            </div>                        
                        </div>
                    </div>
                            ...
                            <div class="col-12">
                                <div class="card card-primary card-outline">
                                    <div class="card-header">
                                        <a href="Cat_LibReg.php" class="btn btn-primary">Registrar</a>                     
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr> 
                                                        ...
                                                        <td style="text-align: center">
                                                            <?= $categoria["estado_aceptado"] == 1 ? '<span class="text-center badge badge-success">Activado</span>' : '<span class="text-center badge badge-danger">Desactivado</span>' ?>
                                                        </td>
                                                        <td style="text-align: center"><a href="Cat_LibEdit.php?categoria_id=<?= $categoria['categoria_id'] ?>" class="btn btn-warning"><i class="fas fa-edit"></i></a></td>
                                                        <td style="text-align: center"><a href="Cat_LibElim.php?categoria_id=<?= $categoria['categoria_id'] ?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a></td>
                                                    </tr>
                                                    <?php endforeach?>
                                                </tbody>
                                            </table>
